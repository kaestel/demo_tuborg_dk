...
//			page.view_port = u.qs("meta[name=viewport]");
//			page.view_port.content = "width=1024";
...
//					u.bug("fade content up");
					...
					// #content height
					if(this.scene.mask.offsetHeight < (u.htmlH() - this.page.hN.offsetHeight - this.page.fN.offsetHeight)) {
						u.a.setHeight(this, u.htmlH() - (this.page.hN.offsetHeight - this.page.fN.offsetHeight));
					}
					else {
						u.a.setHeight(this, this.scene.mask.offsetHeight);
					}
//					u.bug("height:" + this.scene.mask.offsetHeight + "::" + this.scene.offsetHeight + "::" + this.page.offsetHeight + "::" + u.htmlH())
...
//				u.bug("navigate")
				...
				if(u.hc(document.body, "fullscreen")) {
					u.qs("#fullscreen .zoom").clicked();
				}
